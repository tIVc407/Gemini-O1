...
""")):
    ...
    @pytest.mark.asyncio
    async def test_instance_messaging(self, network):
    ...
    @pytest.mark.asyncio
    async def test_mother_node_communication_commands(self, network):
...
"""
    ...
    async def test_synthesize_responses(self, network):
        ...
        with patch('google.generativeai.GenerativeModel') as mock_model:
            mock_model.return_value.generate_content.return_value.text = "Combined response"
